...
<body class="h-full">
        ...
        <nav class="bg-green-300">
            ...
            <div class="flex h-16 items-center justify-between">
                ...
                <div class="shrink-0">
                    <img src="{{ asset('images/flower.jpeg') }}" alt="FlowerLogo" class="size-8" />
                </div>
            ...
            <div class="space-y-1 px-2 pt-2 pb-3 sm:px-3">
                ...
                <a href="/writers" class="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-white/5 hover:text-white">Writer</a>
                <a href="/quotes" class="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-white/5 hover:text-white">Quotes</a>
                <a href="/topics" class="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-white/5 hover:text-white">Topic</a>
        ...
        <header class="relative bg-white shadow-sm">
            <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8 sm:flex sm:justify-between">
                ...
                @php
                    ...
                    // Extract base name (remove "Listing" or "List" if included)
                    $resource = Str::before($heading, ' Listing');
                    $resource = Str::before($resource, ' List');

                    // Make lowercase for route (singular)
                    $route = Str::of($resource)->lower()->plural();
                @endphp

                <x-button href="/{{ $route }}/create">
                    Create {{ $resource }}
                </x-button>
