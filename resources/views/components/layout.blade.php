    ...
    <div class="min-h-full">
        <nav class="bg-green-300">
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-4">
                                ...
                                <x-nav-link href="{{ route('artworks.index') }}" :active="request()->is('artworks')">
                                    Artwork
                                </x-nav-link>
            ...
            <el-disclosure id="mobile-menu" hidden class="block md:hidden">
                <div class="space-y-1 px-2 pt-2 pb-3 sm:px-3">
                    ...
                    <a href="/writers"
                        class="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-white/5 hover:text-white">Writer</a>
                    <a href="/quotes"
                        class="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-white/5 hover:text-white">Quotes</a>
                    <a href="/topics"
                        class="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-white/5 hover:text-white">Topic</a>
        ...
        <header class="relative bg-white shadow-sm">
            <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8 sm:flex sm:justify-between">
                ...
                @isset($resource)
                    <x-button href="{{ route($resource . '.create') }}">
                        Create {{ ucfirst(Str::singular($resource)) }}
                    </x-button>
                @endisset
            </div>
        </header>
